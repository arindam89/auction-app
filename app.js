...
class AuctionApp {
    ...
    renderAuctions() {
        ...
        container.innerHTML = auctions.map(auction => `
            <div class="card auction-card" onclick="app.showAuctionDetail('${auction.id}')">
    ...
    renderTeams() {
        ...
        container.innerHTML = auction.teams.map(team => `
            <div class="card team-card">
                ...
                <div class="card-actions">
                    <button class="btn btn-secondary btn-sm" onclick="app.showTeamForm('${team.id}')">Edit</button>
                    <button class="btn btn-danger btn-sm" onclick="app.deleteTeam('${team.id}')">Delete</button>
                </div>
            </div>
        `).join('');
    }
    ...
    renderPlayers() {
        ...
        container.innerHTML = auction.players.map(player => `
            <div class="card player-card">
                ...
                <div class="card-actions">
                    <button class="btn btn-secondary btn-sm" onclick="app.showPlayerForm('${player.id}')">Edit</button>
                    <button class="btn btn-danger btn-sm" onclick="app.deletePlayer('${player.id}')">Delete</button>
                </div>
            </div>
        `).join('');
    }
